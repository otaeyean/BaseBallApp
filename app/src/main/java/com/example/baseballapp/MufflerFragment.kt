...
import com.example.baseballapp.databinding.FragmentMufflerBinding
...
class MufflerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnAddToCart.setOnClickListener {
            addToCart()
            Toast.makeText(requireContext(), "응원 머플러가 장바구니에 추가되었습니다.", Toast.LENGTH_SHORT).show()
        }
    ...
    private fun addToCart() {
        val cartItem = CartItem(
            productName = "응원 머플러",
            productPrice = 18000,
            productImage = R.drawable.muffler,
            productQuantity = 1
        )
